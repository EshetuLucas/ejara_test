...
class _$PaymentMethodModelImpl extends _PaymentMethodModel {
  _$PaymentMethodModelImpl({this.name, this.id}) : super._();
  ...
  @override
  String toString() {
    return 'PaymentMethodModel(name: $name, id: $id)';
  }
...
abstract class _PaymentMethodModel extends PaymentMethodModel {
  factory _PaymentMethodModel({final String? name, final String? id}) =
